...
public class Typefaces {
    ...
    public static Typeface getRobotoBold() {
        Assert.isMainThread();
        if (sRobotoBold == null) {
            sRobotoBold = Typeface.create("@*android:string/config_bodyFontFamily", Typeface.BOLD);
        }
        return sRobotoBold;
    }
    ...
    public static Typeface getRobotoNormal() {
        ...
        if (sRobotoNormal == null) {
            sRobotoNormal = Typeface.create("@*android:string/config_bodyFontFamily", Typeface.NORMAL);
        }
